...
import { checkSelectedAttributes } from '../../utils/tree.utils';
import { CommonActionTypes } from '../actions';
import { CommonScenarioActions, CommonScenarioActionTypes } from './actions';
...
export function commonScenarioReducer<TState extends IScenarioState>(state: TState, action: CommonScenarioActions): TState
{
	let newTree: Tree;
	let choices: Choice[];
...
export const selectCommonScenario = createFeatureSelector<IScenarioState>('scenario');

export const getGroupsById = createSelector(
	selectCommonScenario,
	(state) =>
	{
		if (!state.tree)
		{
