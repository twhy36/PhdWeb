...
import { PhdCommonModule, Constants } from 'phd-common';
...
const moduleRoutes: Routes = [
	{
		...
		children: [
			...
			{ path: 'spec/:marketid/:communityid', component: NewHomeComponent, data: { buildMode: Constants.BUILD_MODE_SPEC } },
			{ path: 'model/:marketid/:communityid', component: NewHomeComponent, data: { buildMode: Constants.BUILD_MODE_MODEL } },
