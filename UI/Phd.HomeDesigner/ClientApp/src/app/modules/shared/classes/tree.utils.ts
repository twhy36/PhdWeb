...
import { Tree, Choice, DecisionPoint, MappedAttributeGroup, MappedLocationGroup } from '../models/tree.model';
...
import { HomeDesignerAttribute } from '../models/attribute.model';
import { findChoice } from '../../shared/classes/rulesExecutor';
...
function mapLocation(loc: JobChoiceLocation | ChangeOrderChoiceLocation): HomeDesignerAttribute
{
	return <HomeDesignerAttribute>{
...
function mapAttribute(attr: JobChoiceAttribute | ChangeOrderChoiceAttribute): HomeDesignerAttribute
{
	return <HomeDesignerAttribute>{
...
export function mapAttributes(choice: JobChoice | ChangeOrderChoice): Array<HomeDesignerAttribute>
{
	let result: Array<HomeDesignerAttribute> = [];
