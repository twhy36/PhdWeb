...
function getHostInfo() {
    ...
    var isHostExposedNatively = Office && Office.context && Office.context.host;
    var context = isHostExposedNatively ? Office.context : useHostInfoFallbackLogic();
    return {
...
function _parseNotificationParams(params) {
    ...
    if (body instanceof Error) {
        ...
        return {
            message: Object(__WEBPACK_IMPORTED_MODULE_1__util_stringify__["a" /* stringify */])(body),
            title: title,
            type: type || 'default',
            details: null
        };
